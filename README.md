...
4. Click **Configure Recovery** — Lit PKP is provisioned and `recoveryId` is stored.
5. Click **Simulate Device Loss** to clear the signer, then walk through **Recover Access**.
...
3. Check which vault sections to include.
4. Click **Deploy Switch** — Lit Action is deployed and the switch is armed.
...
7. Click **Trigger Switch (Demo)** to simulate the inheritance flow.
...
**PL_Genesis — Frontiers of Collaboration: Infrastructure & Digital Rights**
